...
from app.agent import ask_agent as llm_ask
...
# (Moved to app/auth.py, app/rate_limiter.py, app/cost_guard.py)
...
def metrics(_key: str = Depends(verify_api_key)):
    ...
    return {
        ...
        "budget_used_pct": round(current_cost / settings.daily_budget_usd * 100, 1) if settings.daily_budget_usd else 0.0,
    }
